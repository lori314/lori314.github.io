...
本章会结合我的一个小的项目设计，来介绍我们在ROS1系统上部署代码的一般流程。如果想要在自己的电脑上复现，可以通过以下链接下载代码并在本机训练好我们后面会用的模型：
```
https://bhpan.buaa.edu.cn/link/AA64A6CA6A316C48289F9DCB2EC3C7CD10
文件夹名：Fast-text
有效期限：2030-04-07 19:48
提取码：uU2Y
```
